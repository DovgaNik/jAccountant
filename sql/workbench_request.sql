...
-- INNER JOIN person ON customerinvoice.id = person.id 
-- INNER JOIN customer_transaction ON customer_transaction.invoice_id = customerinvoice.id 
-- INNER JOIN unit_of_measure ON customer_transaction.unit_of_measure_id = unit_of_measure.id
-- INNER JOIN products ON customer_transaction.product_id = products.id);