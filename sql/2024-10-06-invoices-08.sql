...
-- ATU
INSERT INTO `invoice_app`.`ATU` (`name`, `code_of_country`, `atu_type_id`, `residence`, `auto_code`) VALUES 
('Bucharest', 'RO', 2, 'Bucharest', 'B'),
('Los Angeles', 'US', 2, 'Los Angeles County', 'LA'),
('Berlin', 'DE', 2, 'Berlin', 'B');

-- Cities
INSERT INTO `invoice_app`.`Cities` (`name`, `atu_id`, `population`) VALUES 
('Cluj-Napoca', 1, 320000),
('New York City', 2, 8337000),
('Munich', 3, 1472000);
