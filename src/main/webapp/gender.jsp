...
<div class="flex_container">
	<div class="main_table_container">
		<table class="main_table">
			<tr class="main_table_header_row">
				<th class="main_table_header">Gender</th>
			...
			<%
				try {
					...
					ResultSet result = statement.executeQuery("SELECT gender FROM gender");
					while (result.next()) {
						out.println(
								"<tr>" +
										"<form method=\"POST\" action=\"deleteGender\" name=\"deleteGender\" class=\"deleteGender\">" +
											"<td class=\"main_table_data\">" + result.getString("gender") + "</td>" +
											"<td class=\"main_table_data\">" +
												"<input type=\"submit\" value=\"Sterge\"/>" +
												"<input type=\"hidden\" value=\"" + result.getString("gender") + "\" name=\"gender_to_delete\"/>" +
											"</td>" +
										"</form>" +
								"</tr>");
					}
	...
	<div class="sidebar">
		<form method="POST" action="addGender" name="add_form" class="add_form">
			<h1>Add gender</h1>
