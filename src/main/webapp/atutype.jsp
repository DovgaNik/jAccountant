...
<html>
<head>
	<title>ATU Type</title>
	<link href="styles/atutype.css" rel="stylesheet" type="text/css">
	<link rel="icon" href="favicon.ico" />
	<script src="scripts/atutype.js"></script>
</head>
<body>
<div class="header">
...
<div class="flex_container">
			...
			<%
				try {
					...
					while (result.next()) {
						out.println(
								"<tr>" +
										"<form method=\"POST\" action=\"deleteAtutype\" name=\"deleteAtutype\" class=\"deleteAtutype\">" +
											"<td class=\"main_table_data\">" + result.getString("type") + "</td>" +
											"<td class=\"main_table_data\">" +
												"<input type=\"submit\" value=\"Sterge\"/>" +
												"<input type=\"hidden\" value=\"" + result.getString("type") + "\" name=\"atutype_to_delete\"/>" +
											"</td>" +
										"</form>" +
								"</tr>");
					}
	...
	<div class="sidebar">
		<form method="POST" action="addatutype" name="add_form" class="add_form">
			<h1>Add atu type</h1>
